  ...
  <div class="box box-primary"  >
    ...
    <form method="post">
      ...
      <div class="row">
        ...
        <input type="text" class="form-control" name="un" placeholder="username" value="
        <?php foreach ($prf  as $f) { echo $f['user_name'];
        ...
        <input type="email" class="form-control" name="email" placeholder="Email"
              value="
                 <?php foreach ($prf  as $f) { echo $f['email'];
      ...
      <div class="row">
        ...
        <input type="text" class="form-control" name="mb" placeholder="mobile number"
          ...
          value=" <?php foreach ($prf  as $f) { echo $f['mobile'];
