...
<!-- Site wrapper -->
    ...
    <!-- Header Navbar: style can be found in header.less -->
            ...
            <li style="margin-left: 1000px; margin-top: -40px; color: white; font-size: 130%;">
                <a href="<?php echo base_url();?>Home_controler/friend_list"> <?php echo $_SESSION['user'];?></a>
                
            </li>
           <li style="margin-left: 1088px; margin-top: -49px; color: red; font-size: 110%;">
			...
			foreach($prf  as $f)
				{		
					...
					?>
   						...
   						<a href="<?php echo base_url();?>Home_controler/addfriend?id=<?php echo $id?>" type="button" class="btn btn-primary glyphicon glyphicon-user" style="width: 20%;"> Add Friend</a>
   					</div>
